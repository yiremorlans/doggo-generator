...
fetch(BREEDS_URL)
    ...
    .then(data => {
        ...
        for (let i=0; i < breedsArray.length; i++) {
            const option = document.createElement('option') // creates <option></option> in the DOM
...
const getDoggoImg = url => {
    fetch(url) //goes to the API url above
    .then(res => { 
        ...
        // While there remain elements to shuffle…
            ...
            return array;
              ...
              assignFunFact() {
                  ...
                  document.getElementById('funFact').innerHTML = `Fun Fact: ${this.fact}`
              }
